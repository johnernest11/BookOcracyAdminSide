      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
                <div class="row row-sm">
                    <input type="text" name="account_id_edit" id="account_id_edit" class="form-control"  readonly>
                </div>
                <div class="row row-sm">
                      <div class="col-lg-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function show_product(){
          $.ajax({
                type  : 'ajax',
                url   : '<?php echo site_url('AccountController/viewuseraccounts')?>',
                async : true,
                dataType : 'json',
                ...
                //   alert(data);
                    ...
                    for(i=0; i<data.length; i++){
                        html += '<tr>'+
                                ...
                                '<a href="javascript:void(0);" data-bs-toggle="dropdown" class="nav-link leading-none d-flex px-1" data-bs-placement="left" data-bs-toggle="tooltip" title="Select">'+
