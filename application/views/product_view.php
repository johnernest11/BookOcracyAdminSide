                    ...
                    for(i=0; i<data.length; i++){
                        html += '<tr>'+
                                ...
                                '<td style="text-align:right;">'+
                                    '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].AID+'" data-product_name="'+data[i].Full_Name+'" data-price="'+data[i].Username+'">Edit</a>'+' '+
                                    '<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data-product_code="'+data[i].AID+'">Delete</a>'+
                                '</td>'+
                                '</tr>';
                    }
                    $('#show_data').html(html);
